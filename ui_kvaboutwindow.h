...
public:
    ...
    void setupUi(QDialog *KvAboutWindow)
    {
        if (KvAboutWindow->objectName().isEmpty())
            KvAboutWindow->setObjectName(QStringLiteral("KvAboutWindow"));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/png/png_general/info.png"), QSize(), QIcon::Normal, QIcon::Off);
        KvAboutWindow->setWindowIcon(icon);
        KvAboutWindow->setStyleSheet(QLatin1String("QDialog { \n"
...
"}"));
        ...
        logoWidget->setStyleSheet(QLatin1String("QWidget {\n"
...
"font: bold 14px;"));
        ...
        frameCredits->setObjectName(QStringLiteral("frameCredits"));
        frameCredits->setMinimumSize(QSize(0, 180));
        frameCredits->setStyleSheet(QLatin1String("background: transparent;\n"
"alignment: hcenter;"));
    ...
    {
        KvAboutWindow->setWindowTitle(QApplication::translate("KvAboutWindow", "About Kevora", Q_NULLPTR));
        label->setText(QApplication::translate("KvAboutWindow", "Kevora", Q_NULLPTR));
        label_3->setText(QApplication::translate("KvAboutWindow", "Version 1.0", Q_NULLPTR));
    } // retranslateUi
