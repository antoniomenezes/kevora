...
void KvSqlSessionCubrid::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (KvSqlSessionCubrid::*_t)(QTreeWidgetItem * , const QString & , QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KvSqlSessionCubrid::sendTablesOfSchema)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject KvSqlSessionCubrid::staticMetaObject = {
    { &KvSqlSession::staticMetaObject, qt_meta_stringdata_KvSqlSessionCubrid.data,
      qt_meta_data_KvSqlSessionCubrid,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *KvSqlSessionCubrid::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KvSqlSessionCubrid.stringdata0))
        return static_cast<void*>(const_cast< KvSqlSessionCubrid*>(this));
