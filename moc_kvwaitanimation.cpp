...
void KvWaitAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (KvWaitAnimation::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KvWaitAnimation::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject KvWaitAnimation::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_KvWaitAnimation.data,
      qt_meta_data_KvWaitAnimation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *KvWaitAnimation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KvWaitAnimation.stringdata0))
        return static_cast<void*>(const_cast< KvWaitAnimation*>(this));
