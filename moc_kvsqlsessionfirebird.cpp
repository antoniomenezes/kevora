...
void KvSqlSessionFirebird::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (KvSqlSessionFirebird::*_t)(QTreeWidgetItem * , const QString & , QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KvSqlSessionFirebird::sendTablesOfSchema)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject KvSqlSessionFirebird::staticMetaObject = {
    { &KvSqlSession::staticMetaObject, qt_meta_stringdata_KvSqlSessionFirebird.data,
      qt_meta_data_KvSqlSessionFirebird,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *KvSqlSessionFirebird::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KvSqlSessionFirebird.stringdata0))
        return static_cast<void*>(const_cast< KvSqlSessionFirebird*>(this));
