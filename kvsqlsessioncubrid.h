...
#ifndef KVSQLSESSIONCUBRID_H
#define KVSQLSESSIONCUBRID_H
#include "kvsqlsession.h"

/**
  Sql Session for Cubrid:
...
*/
class KvSqlSessionCubrid : public KvSqlSession
{
    Q_OBJECT
public:
    explicit KvSqlSessionCubrid(QObject * parent = 0);
    ...
    void setModuleInfoForSession(QString moduleInfo, QString actionInfo);
    ...
    QStringList getSchemas(bool refreshSchemaList = false);
...
private:
    QString adminViewPrefix;
};

#endif // KVSQLSESSIONCUBRID_H
