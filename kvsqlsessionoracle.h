...
#ifndef KVSQLSESSIONORACLE_H
#define KVSQLSESSIONORACLE_H
#include "kvsqlsession.h"

/**
  Sql Session for Oracle:
...
*/
class KvSqlSessionOracle : public KvSqlSession
{
    Q_OBJECT
public:
    explicit KvSqlSessionOracle(QObject * parent = 0);
