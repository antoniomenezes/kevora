...
#ifndef KVSQLSESSIONSQLITE_H
#define KVSQLSESSIONSQLITE_H
#include "kvsqlsession.h"

/**
  Sql Session for Sqlite:
...
*/
class KvSqlSessionSqlite : public KvSqlSession
{
    Q_OBJECT
public:
    explicit KvSqlSessionSqlite(QObject * parent = 0);
