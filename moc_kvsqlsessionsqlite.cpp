...
void KvSqlSessionSqlite::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (KvSqlSessionSqlite::*_t)(QTreeWidgetItem * , const QString & , QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KvSqlSessionSqlite::sendTablesOfSchema)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject KvSqlSessionSqlite::staticMetaObject = {
    { &KvSqlSession::staticMetaObject, qt_meta_stringdata_KvSqlSessionSqlite.data,
      qt_meta_data_KvSqlSessionSqlite,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *KvSqlSessionSqlite::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KvSqlSessionSqlite.stringdata0))
        return static_cast<void*>(const_cast< KvSqlSessionSqlite*>(this));
