...
#ifndef KVORACLEHIGHLIGHTER_H
#define KVORACLEHIGHLIGHTER_H
...
class KvOracleHighlighter : public QSyntaxHighlighter
{
    Q_OBJECT

public:
    explicit KvOracleHighlighter(QTextDocument *parent = 0);
