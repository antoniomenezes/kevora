...
KvSqlSessionCubrid::KvSqlSessionCubrid(QObject * parent): KvSqlSession(parent)
{
}

QString KvSqlSessionCubrid::databaseForDriver(const QString &driver) {
    if (driver.contains("QCUBRID"))
        return "Cubrid";
    else
        return "";
}

QString KvSqlSessionCubrid::nameForDriver(const QString &driver)
{
    if (driver == "QCUBRID")
        return "Cubrid";
    else
...
QString KvSqlSessionCubrid::getDriverComments(const QString &driver) {
    if (driver == "QCUBRID")
...
QString KvSqlSessionCubrid::getDbmsTypeName() {
    return "Cubrid";
}

QStringList KvSqlSessionCubrid::getTables(const QString &schema)
{
    QStringList result;

    QSqlQuery query("SELECT class_name FROM db_class WHERE owner_name = '"+schema+"' and class_type = 'CLASS' ORDER BY class_name", sessionDatabase);
    while (query.next()) {
...
QStringList KvSqlSessionCubrid::getViews(const QString &schema)
{
    QStringList result;

    QSqlQuery query("SELECT class_name FROM db_class WHERE owner_name = '"+schema+"' and class_type = 'VCLASS' ORDER BY class_name", sessionDatabase);
    while (query.next()) {
        result << query.value(0).toString();
    }
    return result;
...
QStringList KvSqlSessionCubrid::getPrograms(const QString &schema, const QString &type)
{
    QStringList result;
...
QStringList KvSqlSessionCubrid::getEtc(const QString &schema, const QString &type)
{
    QStringList result;
...
QList< QPair<QString, QString> > KvSqlSessionCubrid::getProgramsWithStatus(const QString &schema, const QString &type)
{
...
QList< QPair<QString, QString> > KvSqlSessionCubrid::getEtcWithStatus(const QString &schema, const QString &type)
{
    QString queryEtc;
    QList< QPair<QString, QString> > result;
...
QStringList KvSqlSessionCubrid::getSqlBlocks(QStringList sqlLines, int fromPosition, int toPosition)
{
    ...
    // Grouping all SQL blocks according to Cubrid Syntax
...
QStringList KvSqlSessionCubrid::getDdlFromObject(QString schema, QString objectName, QString objectType, bool showSchema, KvSqlSession::DdlTypes ddlType)
{
...
QStringList KvSqlSessionCubrid::extractConsistentDataSql(QString sqlStatement)
{
    QStringList result = QStringList();
...
QList<KvRecordIdentifier> KvSqlSessionCubrid::extractConsistentData(QString sqlStatement)
{
    QStringList result = QStringList();
...
QStringList KvSqlSessionCubrid::getDependentSql(QString sqlStatement)
{
    QStringList result = QStringList();
    QString statementsByFrom = QString();
    QString statementsByWhere = QString();
...
void KvSqlSessionCubrid::getChildRecords(QString schema, QString table, QString recordClause,
...
void KvSqlSessionCubrid::getParentRecords(QString schema, QString table, QString recordClause,
                                          QMap<QString, KvRecordIdentifier> *mapRecordIds,
                                          QMap<QString, QList<KvTableColumn> > *mapTablesIdColumns,
                                          QMap<QString, QList<KvTableDependency> > *mapTablesDependencies)
{
...
QList<KvTableDependency> KvSqlSessionCubrid::getTableChildRelationships(QString schema, QString table)
{
...
QList<KvTableDependency> KvSqlSessionCubrid::getTableParentRelationships(QString schema, QString table)
{
    QList<KvTableDependency> result = QList<KvTableDependency>();
...
QList< QPair<QString, QMap<QString,QString> > > KvSqlSessionCubrid::getExecPlan(QString sqlStatement, QString StatementId)
{
...
QString KvSqlSessionCubrid::findObjectStatement(QString fullObjectName, QString typeName)
{
...
QMap<QString, QList< QPair<QString, QString> > > KvSqlSessionCubrid::getObjectParents(const QStringList objectList)
{
    if (adminViewPrefix.isEmpty())
        isDbaRoleEnabled();
...
QStringList KvSqlSessionCubrid::getSchemas(bool refreshSchemaList)
{
    QStringList result = QStringList();
    result << "DBA" << "PUBLIC";
    return result;
...
QStringList KvSqlSessionCubrid::getSchemasWithTables()
{
    QStringList result = QStringList();
    result << "DBA" << "PUBLIC";
    return result;
...
QStringList KvSqlSessionCubrid::getSchemasWithViews()
{
    QStringList result = QStringList();
    result << "DBA" << "PUBLIC";
    return result;
...
QStringList KvSqlSessionCubrid::getSchemasWithPrograms()
{
    QStringList result = QStringList();
    result << "DBA" << "PUBLIC";
    return result;
...
QStringList KvSqlSessionCubrid::getSchemasWithEtc()
{
    QStringList result = QStringList();
    result << "DBA" << "PUBLIC";
    return result;
...
QStringList KvSqlSessionCubrid::getProgramsTypes()
{
    QStringList result;
...
QStringList KvSqlSessionCubrid::getEtcTypes()
{
    QStringList result;
...
QList< QPair< QPair<QString, QString>, QPair<QString, QString> > > KvSqlSessionCubrid::getRelationsWithTables(const QList< QPair<QString, QString> > &tables)
{
...
QList< QPair<QString, QString> > KvSqlSessionCubrid::getParentTables(const QString &schema, const QString &table)
{
    QList< QPair<QString, QString> > result;
...
QList< QPair<QString, QString> > KvSqlSessionCubrid::getChildTables(const QString &schema, const QString &table) {
    if (adminViewPrefix.isEmpty())
        isDbaRoleEnabled();
...
int KvSqlSessionCubrid::getColumns(QTableWidget *tableWidget, QString schemaName, QString tableName) {
    if (adminViewPrefix.isEmpty())
        isDbaRoleEnabled();
...
QList<KvColumnInfo> KvSqlSessionCubrid::getColumns(QString schemaName, QString tableName)
{
...
QList<KvTableColumn> KvSqlSessionCubrid::getTableIdentityColumns(QString schemaName, QString tableName)
{
...
QStringList KvSqlSessionCubrid::getTableComments(QString schemaName, QString tableName)
{
    QStringList result;
...
QString KvSqlSessionCubrid::getOnlyTableComments(QString schemaName, QString tableName)
{
...
QStringList KvSqlSessionCubrid::getPrivileges(QString schemaName, QString objectName, QString objectType)
{
    QStringList result;
...
int KvSqlSessionCubrid::getPrivileges(QTableWidget *tableWidget, QString schemaName, QString tableName, bool dbaRoleEnabled)
{
    QSqlError err;
    QString sqlStatement;
...
bool KvSqlSessionCubrid::isDbaRoleEnabled() {
    bool result = false;
...
QStringList KvSqlSessionCubrid::getConstraints(QString schemaName, QString tableName, KvSqlSession::ConstraintsTypes constraintsTypes)
{
    QStringList result;
...
QList< KvTableConstraintInfo > KvSqlSessionCubrid::getUniqueConstraints(QString schemaName, QString tableName) {
...
QList< KvTableConstraintInfo > KvSqlSessionCubrid::getRelationshipConstraints(QString schemaName, QString tableName) {
...
QStringList KvSqlSessionCubrid::describe(const QString &schema, const QString &table) {
...
void KvSqlSessionCubrid::getTablesOfSchema(QTreeWidgetItem *item, const QString &connectionName, const QString &schema)
{
    QStringList tables = getTables(schema);
    emit sendTablesOfSchema(item, schema, tables);
}

// This method is used to identify Cubrid sessions (this information will be presented by querying v$session)
void KvSqlSessionCubrid::setModuleInfoForSession(QString moduleInfo, QString actionInfo)
{
...
QStringList KvSqlSessionCubrid::getIndex(QString schema, QString indexName, bool showSchema)
{
    QStringList result;
    QString sqlStatement = "SELECT OWNER, INDEX_NAME, INDEX_TYPE, TABLE_OWNER, TABLE_NAME, TABLE_TYPE, UNIQUENESS, GENERATED FROM "+
            adminViewPrefix+"_INDEXES WHERE OWNER = :C_OWNER AND INDEX_NAME = :C_INDEX";
    QSqlQuery query(sqlStatement, sessionDatabase);
    query.bindValue(":C_OWNER", schema);
...
QMap<QString,QString> KvSqlSessionCubrid::getSessionInfo()
{
...
void KvSqlSessionCubrid::setObjectTypeNames()
{
    databaseObjectTypeNames << "TABLE" << "VIEW";
    databaseObjectTypeNames << "FUNCTION" << "PROCEDURE" << "TRIGGER";
    databaseObjectTypeNames << "SERIAL";
    databaseObjectTypeNames.sort();
}

void KvSqlSessionCubrid::setObjectTypeOrder()
{
    ...
    databaseObjectTypeOrder << "SERIAL";
    databaseObjectTypeOrder << "FUNCTION" << "PROCEDURE" << "TRIGGER";;
}
